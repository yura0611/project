...
// export const EXAMPLE_DATA: ApplicationsTableItem[] = [
...
//    */
//   private getPagedData(data: ApplicationsTableItem[]): ApplicationsTableItem[] {
//     if (this.paginator) {
...
//    * this would be replaced by requesting the appropriate data from the server.
//    */
//   private getSortedData(data: ApplicationsTableItem[]): ApplicationsTableItem[] {
...
//         case 'candidate': return compare(a.candidate, b.candidate, isAsc);
